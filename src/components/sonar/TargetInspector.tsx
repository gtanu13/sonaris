  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="flex-1 space-y-5 overflow-y-auto p-4">
        ...
        <div className="rounded-lg border border-[--color-depth-border-soft] bg-[--color-depth-surface] p-3">
  <div className="mb-1.5 text-[11px] font-medium tracking-wide text-[--color-ink-500]">
    AI INTERPRETATION
  </div>

  <p className="text-[12px] leading-relaxed text-[--color-ink-300]">
    {detection.anomalyScore >= 0.75
      ? "High anomaly score detected. The target shows strong evidence of being potentially man-made based on its shape, acoustic contrast, shadow consistency, and surrounding seabed context."
      : detection.anomalyScore >= 0.45
        ? "Moderate anomaly detected. The target shows some characteristics that differ from the surrounding seabed, but further human review may be required."
        : "Low anomaly detected. The target appears relatively consistent with the surrounding seabed and known object patterns."}
  </p>
</div>
